...
('3', 'VIP2', 40000, 40000, 1, 4, 50, 0, 80, 4, 1),
('4', 'VIP3', 5000, 5000, 1, 5, 100, 0, 100, 4, 1);
...
CREATE TABLE IF NOT EXISTS `tp_marrycard` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `s` varchar(255) NOT NULL COMMENT '要说的话',
...
--
-- 表的结构 `tp_marrycardbbs`
--

CREATE TABLE IF NOT EXISTS `tp_marrycardbbs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
