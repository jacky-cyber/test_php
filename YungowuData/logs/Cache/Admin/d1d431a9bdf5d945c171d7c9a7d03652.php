 ...
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
	 ...
	 <tr> 
      ...
      <td><input type="text" name="site_url" value="<?php echo C('site_url');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://yungowu.com</span>
    </tr>  
	<tr> 
      <td  height="48" align="right"><strong>机器人名称：</strong></td>
      <td><input type="text" name="site_my" value="<?php echo C('site_my');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://yungowu.com</span>
    </tr> 
	<tr> 
	...
	<tr> 
      <td  height="48" align="right"><strong>号码：</strong></td>
      <td><input type="text" name="site_hm" value="<?php echo C('site_hm');?>" class="ipt" size="45" />
      <span>&nbsp;&nbsp;例如:13800008888或138-0000-8888</span>
    </tr>
    <tr> 
	...
	<tr> 
      ...
      <td><input type="text" name="site_email" value="<?php echo C('site_email');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:QQ:server@yungowu.com</span>
    </tr>
	<tr> 
	...
	<tr> 
      ...
      <td><textarea	 type="text" name="copyright" class="ipt" style="width:450px;height:60px;margin:5px 0 5px 0;" /><?php echo C('copyright');?></textarea><span>&nbsp;&nbsp;例:yungowu版权所有</span>
    </tr>
