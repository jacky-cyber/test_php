...
<meta name="keywords" content="<?php echo C('site_name');?>-YunGoWu后台管理系统" />
<meta name="description" content="<?php echo C('site_name');?>-YunGoWu后台管理系统" />
  ...
  <tr>
	...
	<div class="top">
    	<a href="/" class="logo" title="首页">首页</a>
		 <div class="login">
			<li>您好：<b><?php echo (session('username')); ?></b> ，欢迎使用YunGoWu！</li>	
			<li><a href="<?php echo C('site_url');?>">访问首页</a></li>
			<li><a href="/index.php?g=User&m=Index&a=index" target="_blank">用户中心</a></li>
			<li><a target="_blank"  href="http://idc118.taobao.com">淘宝店首页</a></li>
