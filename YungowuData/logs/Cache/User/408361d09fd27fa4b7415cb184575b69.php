                    ...
                    <td align="right"><label for="title">背景音乐：</label></td>
                     ...
                     <tr>
                       ...
                       <table border="0" cellspacing="0" cellpadding="0" class="quanjing">
                         ...
                         <tr>
                           <td align="center"><script src="<?php echo C('site_url');?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('frontpic',1000,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('frontpic')">预览</a></td>
