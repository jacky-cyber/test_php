 ...
 ?>" style="width:90px;" onClick="WdatePicker()"></td>
	...
	<div class="msgWrap bgfc"> 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
					<td width="49%" valign="top">会员卡使用说明：<br>
						<textarea class="px" id="info" name="cardinfo" style="width: 200px; height: 200px; display: none;"><?php echo ($exchange["cardinfo"]); ?></textarea>
				  </td>
					<td width="51%" valign="top">积分规则说明：<br>
						<textarea class="px" id="info2" name="cardinfo2" style="width: 200px; height: 200px; display: none;"><?php echo ($exchange["cardinfo2"]); ?></textarea>
				  </td>
				</tr>
				<tr>
					<td colspan="2">
