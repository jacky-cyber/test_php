...
<script src="<?php echo C('site_url');?>/tpl/static/artDialog/plugins/iframeTools.js"></script>
 ...
 <tr> 
        ...
        <td><select name="parentid"><option value="0">根分类</option>
		<?php if(is_array($parentidlist)): $i = 0; $__LIST__ = $parentidlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
