     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        ...
        <td><input type="text" name="ppicurl" value="<?php echo ($set["ppicurl"]); ?>" id="pic" class="px" style="width:400px;" />   <script src="<?php echo C('site_url');?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a> &nbsp;&nbsp;推荐大小为720x400</td> 
       </tr> 
       <tr> 
        <th><span class="red">*</span>订单页头部图片：</th> 
        <td><input type="text" id="pic1" name="headpic" value="<?php if($set["headpic"] != false): echo ($set["headpic"]); else: echo RES;?>/images/cart_info/online.jpg<?php endif; ?>" class="px" style="width:400px;" />  <script src="<?php echo C('site_url');?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic1',720,125,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a> &nbsp;&nbsp;推荐大小为720x400 不会自定义请留空:填写图片外链地址，推荐大小为720x125，高度可根据自身需求调整。<br />不填默认本图片: <a target="ss" href="<?php echo C('site_url');?>/tpl/User/default/common/images/cart_info/online.jpg">点击查看</a> </td> 
       </tr> 
           ...
           <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%"> 
            ...
            <tbody> 
             <tr> 
              ...
              <td width="200"><input type="text" name="picurl" value="<?php echo ($set["picurl"]); ?>" id="pic2" class="px" style="width:160px;" />   <script src="<?php echo C('site_url');?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic2',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic2')">预览</a> &nbsp;&nbsp;</td> 
