...
<td><?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zo): $mod = ($i % 2 );++$i; if($zo['id'] == $vo['pid']): echo ($zo["name"]); endif; endforeach; endif; else: echo "" ;endif; ?>
</td>
