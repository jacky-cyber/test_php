...
<TABLE class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
    <THEAD>
<TR>
  <TH valign="top"><label for="keyword">父级分类：</label></TH>
  <TD><select name="pid"><option value="">根分类</option>
  <?php if(is_array($pidlist)): $i = 0; $__LIST__ = $pidlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
  </select>
                  </TD>
  <TD>&nbsp;</TD>
</TR>
...
<tr>
   <th valign="top"><label for="keyword">选择模版:</label></th><TD><select name="tpl"><option value="">选择模版</option>
   <?php for($i=1;$i<=38;$i++) { if($i<10)$i='0'.$i; $tpl=$tpl.'<option value="'.$i.'">模版'.$i.'</option>'; } echo $tpl; ?>
   </select></TD>
   </tr>
