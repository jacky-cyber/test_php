...
<!-- Stylesheet Load -->
<link href="<?php echo RES;?>/css/118/style.css" rel="stylesheet" type="text/css">
<link href="<?php echo RES;?>/css/118/framework-style.css" rel="stylesheet" type="text/css">
<link href="<?php echo RES;?>/css/118/framework.css" rel="stylesheet" type="text/css">
<link href="<?php echo RES;?>/css/118/coach.css" rel="stylesheet" type="text/css">
<link href="<?php echo RES;?>/css/118/bxslider.css" rel="stylesheet" type="text/css">
<link href="<?php echo RES;?>/css/118/swipebox.css" rel="stylesheet" type="text/css">
<link href="<?php echo RES;?>/css/118/icons.css" rel="stylesheet" type="text/css">
<link href="<?php echo RES;?>/css/118/retina.css" rel="stylesheet" type="text/css" media="only screen and (-webkit-min-device-pixel-ratio: 2)">


<!--Page Scripts Load -->
<script src="<?php echo RES;?>/css/118/jquery.min.js" type="text/javascript"></script>	
<script src="<?php echo RES;?>/css/118/snap.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/118/hammer.js" type="text/javascript"></script>	
<script src="<?php echo RES;?>/css/118/jquery-ui-min.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/118/subscribe.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/118/contact.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/118/jquery.swipebox.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/118/bxslider.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/118/colorbox.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/118/retina.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/118/custom.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/118/framework.js" type="text/javascript"></script>
...
<div class="all-elements">
    ...
    <div id="content" class="page-content" style="">
    	<div class="page-header">
        	...
        	<img class="logo" src="<?php echo RES;?>/css/118/logo.png" alt="img" width="85">
   		</div>
