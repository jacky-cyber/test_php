...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<link href="<?php echo RES;?>/css/201/cate<?php echo ($tpl["tpltypeid"]); ?>_<?php echo ($tpl["color_id"]); ?>.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo RES;?>/css/201/plugmenu.css" rel="stylesheet" type="text/css" />
        <script src="<?php echo RES;?>/css/201/iscroll.js" type="text/javascript"></script>
	...
	<div class="main">
		...
		<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; $ii++; ?>
                        ...
                        <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo ($vo["url"]); endif; ?>">
                      	<div>
                                                             <span  class="icon" style="background:url(<?php echo ($vo["img"]); ?>) no-repeat;background-size:100% 120px;"><em></em></span>
...
<script src="<?php echo RES;?>/css/201/zepto.min.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/201/plugmenu.js" type="text/javascript"></script>
<div class="copyright">
